const RUTAS = [
  ...
  { id: 'R-03', conductor: 'C. Vega', zona: 'ZM040-BCN-03', clientes: 15, palets: 6, zce: 298, retornables: 176, estado: 'completada', horaInicio: '06:15', ventanas: 13, cumplidas: 13, km: 31.7, tipo: '6P' },
  { id: 'R-04', conductor: 'F. Navarro', zona: 'ZM040-BCN-04', clientes: 12, palets: 3, zce: 156, retornables: 89, estado: 'alerta', horaInicio: '07:00', ventanas: 10, cumplidas: 6, km: 18.9, tipo: 'FURGO' },
  { id: 'R-05', conductor: 'H. Suárez', zona: 'ZM040-BCN-05', clientes: 24, palets: 8, zce: 512, retornables: 318, estado: 'en-ruta', horaInicio: '06:30', ventanas: 22, cumplidas: 19, km: 63.4, tipo: '8P' },
  ...
  { id: 'R-07', conductor: 'M. García', zona: 'ZM040-BCN-07', clientes: 19, palets: 8, zce: 428, retornables: 251, estado: 'en-ruta', horaInicio: '06:45', ventanas: 17, cumplidas: 15, km: 51.8, tipo: '8P' },
  ...
  { id: 'R-09', conductor: 'A. Díaz', zona: 'ZM040-BCN-09', clientes: 8, palets: 3, zce: 142, retornables: 84, estado: 'pendiente', horaInicio: '09:00', ventanas: 6, cumplidas: 0, km: 14.3, tipo: 'FURGO' },
  { id: 'R-10', conductor: 'R. López', zona: 'ZM040-BCN-10', clientes: 20, palets: 8, zce: 487, retornables: 296, estado: 'alerta', horaInicio: '06:30', ventanas: 18, cumplidas: 11, km: 54.9, tipo: '8P' },
]
    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', padding: '18px 22px', overflow: 'hidden' }}>
      ...
      <div style={{ display: 'flex', gap: 16, marginBottom: 12, flexShrink: 0 }}>
        ...
        <div style={{ marginLeft: 'auto', fontSize: 11, color: 'rgba(160,170,200,.4)', fontStyle: 'italic' }}>
          1 palé = 60 ZCE · 1 barril = 4 ZCE · ~60% mercancía retornable
        </div>
      </div>
      ...
      <div style={{ flex: 1, overflowY: 'auto', border: '1px solid rgba(255,255,255,.07)', borderRadius: '0 0 8px 8px' }}>
        {RUTAS.map((r, i) => {
          ...
          return (
            <div key={r.id} style={{ display: 'grid', gridTemplateColumns: COLS, gap: 0, padding: '11px 14px', alignItems: 'center', background: i % 2 === 1 ? 'rgba(255,255,255,.015)' : 'transparent', borderBottom: i < RUTAS.length - 1 ? '1px solid rgba(255,255,255,.04)' : 'none', cursor: 'default', transition: 'background .15s' }}
            ...
            >
              ...
              <span style={{ fontSize: 11, fontWeight: 700, padding: '2px 8px', borderRadius: 20, background: tip.bg, color: tip.color, width: 'fit-content' }}>{r.tipo}</span>
